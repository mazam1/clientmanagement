<!-- Sidebar -->
<aside id="sidebar" class="fixed left-0 top-0 h-full w-sidebar bg-sidebar-bg text-sidebar-text transition-all duration-200 ease-in-out z-40 flex flex-col">
    <!-- Logo Area -->
    <div class="flex items-center justify-center h-16 border-b border-sidebar-hover">
        ...
        <ul class="space-y-1">
            ...
            <li>
                <a href="{{ route('dashboard') }}"
                   class="flex items-center px-4 py-3 rounded-lg transition-colors duration-150 {{ request()->routeIs('dashboard') ? 'bg-sidebar-active text-sidebar-text border-l-4 border-accent-primary' : 'text-sidebar-text-muted hover:bg-sidebar-hover hover:text-sidebar-text' }}">
